...
```javascript
lark_api({ tool: 'drive', op: 'version-get', args: {
  file_token: 'boxcnxxxxxxxx', version: '7633658129540910621', as: 'bot'
} })

lark_api({ tool: 'drive', op: 'version-get', args: {
  file_token: 'boxcnxxxxxxxx', version: '7633658129540910621', as: 'user'
} })

lark_api({ tool: 'drive', op: 'version-get', args: {
  file_token: 'boxcnxxxxxxxx', version: '7633658129540910621',
  output: './downloads/', as: 'bot'
} })

lark_api({ tool: 'drive', op: 'version-get', args: {
  file_token: 'boxcnxxxxxxxx', version: '7633658129540910621',
  output: './artifact.bin', overwrite: true, as: 'bot'
} })
```
