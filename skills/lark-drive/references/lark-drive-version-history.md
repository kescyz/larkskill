...
```javascript
lark_api({ tool: 'drive', op: 'version-history', args: { file_token: 'boxcnxxxxxxxx', as: 'bot' } })

lark_api({ tool: 'drive', op: 'version-history', args: { file_token: 'boxcnxxxxxxxx', as: 'user' } })

lark_api({ tool: 'drive', op: 'version-history', args: {
...
lark_api({ tool: 'drive', op: 'version-history', args: { file_token: 'boxcnxxxxxxxx', dry_run: true, as: 'bot' } })
```
