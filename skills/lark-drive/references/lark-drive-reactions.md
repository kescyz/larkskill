...
lark_api({ tool: 'drive', op: 'file.comments.list', args: {
  params: { file_token: '<DOC_TOKEN>', file_type: 'docx', need_reaction: true }
} })

// 已知 comment_id，批量查询评论卡片 reaction
lark_api({ tool: 'drive', op: 'file.comments.batch_query', args: {
...
lark_api({ tool: 'drive', op: 'file.comment.replys.list', args: {
...
lark_api({ tool: 'drive', op: 'file.comment.reply.reactions.update_reaction', args: {
  params: { file_token: '<DOC_TOKEN>', file_type: 'docx' },
