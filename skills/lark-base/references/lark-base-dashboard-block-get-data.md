...
```javascript
lark_api({ tool: 'base', op: 'dashboard-block-get-data', args: { base_token: 'bascn***************CtadY', block_id: 'chtxxxxxxxx' } })
```
...
```javascript
// 先看仪表盘里有哪些组件
lark_api({ tool: 'base', op: 'dashboard-block-list', args: { base_token: 'bascn***************CtadY', dashboard_id: 'blkxxxxxxxx' } })
...
```javascript
lark_api({ tool: 'base', op: 'dashboard-block-get', args: { base_token: 'bascn***************CtadY', dashboard_id: 'blkxxxxxxxx', block_id: 'chtxxxxxxxx' } })
```
...
```javascript
lark_api({ tool: 'base', op: 'dashboard-block-get-data', args: { base_token: 'bascn_example_token', block_id: 'chtxxxxxxxx', dry_run: true, format: 'pretty' } })
```
