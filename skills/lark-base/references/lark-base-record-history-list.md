...
```javascript
lark_api({ tool: 'base', op: 'record-history-list', args: { base_token: '<base_token>', table_id: '<table_id>', record_id: '<record_id>' } })

lark_api({ tool: 'base', op: 'record-history-list', args: { base_token: '<base_token>', table_id: '<table_id>', record_id: '<record_id>', page_size: 30, max_version: '<next_max_version>' } })
```
