...
```javascript
// 创建记录
lark_api({ tool: 'base', op: 'record-upsert', args: { base_token: '<base_token>', table_id: '<table_id>', json: '{"项目名称":"Apollo","状态":"进行中"}' } })

// 更新记录
lark_api({ tool: 'base', op: 'record-upsert', args: { base_token: '<base_token>', table_id: '<table_id>', record_id: '<record_id>', json: '{"项目名称":"Apollo","状态":"完成","完成时间":"2026-03-24 10:00:00"}' } })
```
