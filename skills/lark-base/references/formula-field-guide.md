...
When creating or updating a formula field via MCP tool `lark_api` with `"type": "formula"`, read this guide first before constructing the field JSON body.

Do **not** construct the formula field body before reading this guide.
