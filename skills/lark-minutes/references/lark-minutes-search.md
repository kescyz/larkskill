...
// 分页查询
lark_api({ tool: 'minutes', op: 'search', args: { query: '预算复盘', page_size: 20 } })
lark_api({ tool: 'minutes', op: 'search', args: { query: '预算复盘', page_size: 20, page_token: '<PAGE_TOKEN>' } })
```
...
// 查妙记关联的纪要产物：逐字稿、总结、待办、章节等 → 用 lark-vc +notes
