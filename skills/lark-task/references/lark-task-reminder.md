...
lark_api({ tool: 'task', op: 'reminder', args: { task_id: '<task_guid>', set: '30' } })

// Set a reminder (e.g., 1 hour before due)
lark_api({ tool: 'task', op: 'reminder', args: { task_id: '<task_guid>', set: '1h' } })

// Remove all reminders
lark_api({ tool: 'task', op: 'reminder', args: { task_id: '<task_guid>', remove: 'true' } })
```
