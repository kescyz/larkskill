...
lark_api({ tool: 'wiki', op: 'node-get', args: {
  ...
  // objType: 'docx',           // optional: doc|docx|sheet|bitable|mindnote|slides|file
  // spaceId: '<space_id>',     // optional cross-check
  // format: 'json',            // optional: json|pretty|table|csv|ndjson
  // as: 'user',                // optional
} })
```
